    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col bg-wh overflow-y-auto px-6 py-8 sm:px-10">
        <div className="w-full max-w-sm mx-auto my-auto">
          {/* Mobile Header */}
          <div className="flex lg:hidden items-center gap-3 mb-6 pb-4 border-b border-bc">
            <div>
              <h1 className="font-rajdhani text-2xl font-black leading-tight tracking-tighter">
                <span className="text-db">My</span>
                <span className="text-sf italic">Campus</span>
              </h1>
              <p className="text-[11px] text-mt font-bold uppercase tracking-wider">Smart Student Portal</p>
            </div>
          </div>
          {children}
        </div>
